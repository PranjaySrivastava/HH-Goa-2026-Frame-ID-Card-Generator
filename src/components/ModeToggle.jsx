...
export default function ModeToggle({ mode, onChange }) {
  return (
    <div role="tablist" aria-label="Output format" className="grid grid-cols-2 gap-1.5 bg-black/30 backdrop-blur-md rounded-xl p-[5px] mb-4 border border-white/5">
      <TabButton
        active={mode === "pfp"}
  ...
  return (
    <button
      ...
      className={
        ...
        (active
          ? "bg-hh-pink text-white shadow-[0_6px_14px_-4px_rgba(255,46,166,0.6)]"
